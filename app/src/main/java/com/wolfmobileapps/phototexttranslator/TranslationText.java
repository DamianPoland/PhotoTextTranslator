...
public class TranslationText {
    ...
    public void getTextTranslation(final Context context, final String translationFrom, String translationTo, String textToTranslate){

        RequestQueue queue = Volley.newRequestQueue(context); // utworzenie requst
        ...
        String url = host + post + questionMark + language +format + key + "&text=" + textToTranslate; // końcowy url
